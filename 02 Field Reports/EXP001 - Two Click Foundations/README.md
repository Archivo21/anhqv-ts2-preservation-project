...
Determine whether two-click foundations can be created and extended entirely within the unmodified *The Sims 2* build engine without using LotAdjuster.
...
To be completed from the working notes and recording review.

## Procedure

To be reconstructed and documented precisely enough for an independent builder to reproduce.
...
See the related research-journal question record.

## Media

See:

- [EXP001 video evidence record](../../08%20Assets/Videos/EXP001%20-%20Two%20Click%20Foundations/README.md)
...
A Video Editor Specialist is the immediate recruitment priority for preparing the public evidence package.
